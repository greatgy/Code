...
<link href="${webimg}/imgs/sys/favicon.ico" rel="shortcut icon" />
...
<!--[if IE 6]>
<script type="text/javascript" src="${basejs}/js/ie/image/png.min.js"></script>
<script>
...
<![endif]-->
<link rel="stylesheet" type="text/css" href="${basecss}/css/default/reset.css" class="cssfx" />
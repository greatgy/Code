...
public class PKCS7Tool {
	...
	private static final int SIGNER = 1;//签名
	private static final int VERIFIER = 2;//验证
	private int mode = 0;//用途
	private String digestAlgorithm = "SHA1";//摘要算法
	private String signingAlgorithm = "SHA1withRSA";//签名算法
	private X509Certificate[] certificates = null;//签名证书链
	private PrivateKey privateKey = null;//签名私钥
	private Certificate rootCertificate = null;//根证书
	private static char jvm = 0;//JVM 提供商

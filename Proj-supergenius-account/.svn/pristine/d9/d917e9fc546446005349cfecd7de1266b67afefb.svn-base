...
public class QuickPayConf {
	// 版本号
		...
		/* 前台交易测试环境 */
		private final static String UPOP_BASE_URL = SysConf.BankUnionpayBaseUrl;
		...
		/* 后台交易测试环境 */
		private final static String UPOP_BSPAY_BASE_URL = SysConf.BankUnionpayBSpayBaseUrl;
...
//		private final static String UPOP_BSPAY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
		...
		/* 查询交易测试环境 */
		private final static String UPOP_QUERY_BASE_URL = SysConf.BankUnionpayQueryBaseUrl;
...
//		private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
		...
		// 商户代码
		public final static String merCode = SysConf.BankUnionpayMerCode;

		// 商户名称
		public final static String merName = SysConf.BankMerName;

		public final static String merFrontEndUrl = SysConf.BankMerFrontEndUrl;

		public final static String merBackEndUrl = String.format(SysConf.BankMerBackEndUrl, EBank.unionpay);
		...
		public final static String securityKey = SysConf.BankUnionpaySecurityKey;

package com.genius.core.cache.third;
...
public class RedisClientTest {
	...
	public void append() {
		rc.del(a("mykey"));
		assertEquals(5, (long) rc.append("mykey", "Hello").data());
	}
	...
	public void bitcount() {
		rc.set("bitkey", "3");
		assertEquals(2, rc.bitcount("bitkey", null, null));
	}
	...
	public void bitop() {
		rc.set("bitkey1", "A");
		rc.set("bitkey2", "B");
		assertEquals(1, rc.bitop("xor", "bitkey", new Object[] { "bitkey1", "bitkey2" }));
		assertEquals("\03".getBytes(), rc.get("bitkey").data());
	}

	@Test
	public void blpop() {
		rc.del(a("list1", "list2"));
		eq(1, rc.rpush("list1", a("a")));
	...
	public void brpop() {
		rc.del(a("list1", "list2"));
		eq(1, rc.rpush("list1", a("a")));
		eq(2, rc.rpush("list1", a("b")));
		eq(3, rc.rpush("list1", a("c")));
	...
	public void sort() {
		...
		eq(1, rc.lpush("list", a("a")));
		eq(2, rc.lpush("list", a("b")));
		eq(3, rc.lpush("list", a("c")));
		eq(4, rc.lpush("list", a("ab")));
		eq(5, rc.lpush("list", a("bc")));
	...
	public void MGetTest() {
		...
		rc.set("test2", "value2");
		rc.set("test3", "value3");
		MultiBulkReply values = rc.mget(keys);
	...
	public void HashTest() {
		rc.del(new Object[] { "hash" });
		rc.hset("hash", "field1", "value1");
		rc.hset("hash", "field2", "value2");
		rc.hset("hash", "field3", "value1");
		MultiBulkReply hash = rc.hgetall("hash");

...
@Maps(strategy={Maps.defaultStrategy}, includeTypeStrategy = Maps.cacheStrategy)
@MapsIgnore(strategy=Maps.allStrategy, value={"readBooks"})
public class User extends BaseEntity {
	...
	@Maps(strategy=Maps.cacheStrategy)
...
//	}
	...
	public void setReadBooks(Book[] books) {

	...
	<div class="top clear">
    	<div class="top_main1">
	    	...
	    	<ul class="top_left">
	            ...
	            <li><a href=[#if member??]"http://sns.supergenius.cn"[#else]"javascript:;" class="normalUsertip"[/#if]>人间仙境</a></li>
	            
	        </ul>
	        <ul class="top_right">
                <li class="member"><a href="http://www.supergenius.cn/huiyuan" target="_blank">会员通道</a></li>
	           [#if me??]
	        	<li class='member'><a href="${base}/offline">退出</a></li>
	        	<li class="member">
		        	<a href="${userbase}" target="_blank">
			        	<span class="headerName">
			        		...
			        		[#else]
			        			<span class="username3">[@p.TrimUsername content="${me.username}" mylength=8 /]<span>
			        		[/#if]
			        	</span>
		        	</a>
	        	</li>
	           ...
	           [#else]
                ...
                <li class="tr_act login"><a href="${userbase}/login" style="cursor:pointer;">登录</a></li>
	           [/#if]
	        </ul>
        </div>
    	<!-- 非会员提醒 -->
		...
		<div class="normalUser">
			...
			<div class="normalTipbox">
				...
				<a href="${userbase}" class="beuser">加入超天才会员</a>
			</div>
		</div>

...
<link rel="stylesheet" type="text/css" href="${basecss}/css/default/xcConfirm.css">
					...
					<div class="centercontainer">
						<div class="centerleft">
							<h2>
								...
								会员登录&nbsp;&nbsp;|&nbsp;&nbsp;
									<a href="${base}/login/user" class="memberLogin normalLogin">用户登录</a>
							</h2>
							<form id="loginForm" action="${base}/login" class="inputs" method="post">
								...
								[/#if]
								<a onclick="submitForm()" class="loginbut">登录</a>
							...
							<div class="otherLink">
								<a href="${base}/login/wx" ><img src="${baseimg}/imgs/default/bweixin.png" alt="微信" title="微信" /></a>
...
<script type="text/javascript" src="${basejs}/js/libs/xcConfirm.js"></script>
<script type="text/javascript">
	$(function(){
		...
		$('input[name="token"]').keydown(function(){  
         ...
         [#if err.err_isnotmember??]
        	var txt=  "该账号尚未注册为会员，是否转到用户登录？";
			var option = {
				title: "提示",
				btn: parseInt("0011",2),
				onOk: function(){
					window.location.href="${base}/login/user"
				}
			}

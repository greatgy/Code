				...
				<div class="logincenter">
					<div class="centercontainer">
						<div class="centerleft centerleftgreen">
							...
							<div class="otherLink">
								<a href="${base}/login/wx" target="_blank"><img src="${baseimg}/imgs/default/bweixin.png" alt="微信" title="微信" /></a>
...
<script type="text/javascript">
	$(function(){
       ...
       [#if err.err_isnotuser??]
			var txt=  "该账号已经注册为会员，是否转到会员登录？";
			var option = {
				title: "提示",
				btn: parseInt("0011",2),
				onOk: function(){
					window.location.href="${base}/login/member"
				}
			}

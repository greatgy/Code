...
public class LoginRegController extends BaseController {
	...
	public String register(Map<String, Object> model, String email, String password, String password2, String code, String agreement, HttpServletRequest request, HttpServletResponse response) {
		...
		if (flag) {
			...
			if (UserHP.register(user, false)) {
				...
				if (ValidUtil.isEmail(email)) {
					user.getUserInfo().setAisle(Integer.parseInt(EUserAisle.mailbox.toString()));
				}
				if (ValidUtil.isMobile(email)) {
					user.getUserInfo().setAisle(Integer.parseInt(EUserAisle.mobile.toString()));
				}
	...
	public String register_improve(Map<String, Object> model, @PathVariable String uid, User user, String selectcountry, String name, String identityid, String passport, 
			String checkCode, String mobile, String password, String password2, HttpServletRequest request) {
		...
		if (flag) {
			...
			if (!StrUtil.isEmpty(passport)) {
				...
				user2.getUserInfo().setCountry(selectcountry);
			}

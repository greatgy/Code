...
package com.genius.captcha.module.config;

import java.util.ResourceBundle;

import com.genius.captcha.module.CaptchaModuleException;
...
public class CaptchaModuleConfig {
    ...
    private String messageType = com.genius.captcha.module.config.CaptchaModuleConfig.MESSAGE_TYPE_TEXT;

    private String messageValue = "You failed the jcaptcha test";

    private String messageKey = "jcaptcha_fail";

    private String idType = com.genius.captcha.module.config.CaptchaModuleConfig.ID_SESSION;
    ...
    public void validate() {
        ...
        //verify values
        if (!(com.genius.captcha.module.config.CaptchaModuleConfig.MESSAGE_TYPE_TEXT.equals(messageType) || CaptchaModuleConfig.MESSAGE_TYPE_BUNDLE.equals(messageType)))
            throw new CaptchaServiceException("messageType can " +
                    "only be set to '" + com.genius.captcha.module.config.CaptchaModuleConfig.MESSAGE_TYPE_TEXT + "' or '" + CaptchaModuleConfig.MESSAGE_TYPE_BUNDLE + "'");

        if (!(com.genius.captcha.module.config.CaptchaModuleConfig.ID_SESSION.equals(idType) || CaptchaModuleConfig.ID_GENERATED.equals(idType)))
            throw new CaptchaServiceException("idType can " +
                    "only be set to '" + com.genius.captcha.module.config.CaptchaModuleConfig.ID_SESSION + "' or '" + CaptchaModuleConfig.ID_GENERATED + "'");
        ...
        if ((idType.equals(CaptchaModuleConfig.ID_GENERATED)) && (idKey == null || "".equals(idKey)))
            throw new CaptchaServiceException("idKey cannot be null or empty when id is generated (ie idType='" + CaptchaModuleConfig.ID_GENERATED + "'");

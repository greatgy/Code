...
<body>
	...
	<div class="searchTop">
		...
		<form action="${base}/search" class="searchForm" onsubmit ="return validate()">
			...
			<button class="submit">搜索</button>&nbsp
			<button type="button" class="submit authorSearch">搜作者</button>
		</form>
	</div>
	<ul class="selectPart">
		<li id="all">
		...
		<li id="gupage">
			<a href="javascript:void(0)">顾雏军专栏</a>
		</li>
		<li id="finance">
			<a href="javascript:void(0)">天财评论</a>
		</li>
		<li id="life">
			<a href="javascript:void(0)">天才人生</a>
		</li>
		<li id="startup">
		...
		<li id="enterpriser">
			<a href="javascript:void(0)">引资购商</a>
		</li>
		<li id="managernews">
			<a href="javascript:void(0)">职业经理人培训</a>
		</li>
		<li id="entrepreneur">
			<a href="javascript:void(0)">企业家培训</a>
		</li>
		<li id="moralnews">
			<a href="javascript:void(0)">职业道德培训</a>
		</li>
		<li id="ai">
	...
	<!--
		...
		var gupagebase = '${gupagebase}';
		var enterpriserbase = '${enterpriserbase}';
		var lifebase = '${lifebase}';
		var managernewsbase = '${managernewsbase}';
		var entrepreneurbase = '${entrepreneurbase}';
		var moralnewsbase = '${moralnewsbase}';
		var searchid;
		var prepage=1;
		var PageData = {
			start : 0,
		...
		$(function($){
			$(".authorSearch").click(function(){
				gourl("${base}/search?target=author&content=" + encodeURI($("#searchcontent").val()) + "&channel=${channel}");
			});

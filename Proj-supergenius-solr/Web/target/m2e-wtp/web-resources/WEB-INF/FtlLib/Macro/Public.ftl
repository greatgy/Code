		...
		<div class="logincontainer" onkeydown="keyLogin();">
			...
			<div class="logincontent">
				...
				<form action="" class="inputs">
					<ul class="inputsul">
						<li>
							...
							<input type="text" id="usersinform" class="usersinform" maxlength="255" placeholder="请输入您注册的邮箱" name="usersn" oninput="loginButton();"/>
						</li>
						<li>
				...
				<div class="registerlink">
					还没有超天才帐号，<a href="${userbase}/register" target="_blank">立即注册</a>
				</div>
				<div class="otherLink">
					<a href="${base}/login/wx" target="_blank"><img class="imglogin" src="${baseimg}/imgs/default/bweixin.png" alt="微信" title="微信" /></a>
					<a href="${base}/login/qq" target="_blank"><img class="imglogin" src="${baseimg}/imgs/default/bqq.png" alt="qq" title="qq" /></a>
					<a href="${base}/login/weibo" target="_blank"><img class="imglogin" src="${baseimg}/imgs/default/bsina.png" alt="微博" title="微博" /></a>
				</div>
			</div>
		</div>
	</div>

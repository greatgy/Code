...
public class InsertDataTest {
	@Autowired
	SqlSessionFactory sqlSessionFactoryManagerDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GManagerDB";
	
	@Test
	public void inserGManagerData() throws IOException {
		...
		try {
			...
			conn = sqlSessionFactoryManagerDB.openSession().getConnection();
			for (String sql : strs) {
	...
	@Test
	public void insertGManagerTestData() throws IOException {

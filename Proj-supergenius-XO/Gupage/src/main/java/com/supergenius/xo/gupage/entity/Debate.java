...
public class Debate extends BaseEntity implements Comparable<Debate> {

	private static final long serialVersionUID = 5562322234896378031L;
	private int cid;
	...
	@Override
	public int compareTo(Debate o) {
		if (this == o) {
			return 0;
		} else if (o != null && o instanceof Debate) {
			Debate article = (Debate) o;

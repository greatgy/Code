...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryGupageDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GGupageDB";
	
	@Test
	public void insertGUserDB2Data() throws IOException {
		System.out.println("-----------invoking method: insertGUserDB2Data");
		...
		try {
			...
			conn = sqlSessionFactoryGupageDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	public void insertGUserDB2TestData() throws IOException {
		System.out.println("-----------invoking method: insertGUserDB2TestData");

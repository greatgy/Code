...
import com.supergenius.core.rule.PrizeCountCommentsCareerRule;
...
public class Comments extends BaseEntity {
	...
	public long getPrizecount() {
		Rule rule = new PrizeCountCommentsCareerRule(this.uid);
	...
	public Long getCommentcount() {
		Rule rule = new CareerArticleSecondCommentCountRule(this.uid);

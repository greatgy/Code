...
import com.supergenius.core.rule.CareerProblemSecondCommentCountRlue;
import com.supergenius.core.rule.PrizeCountAnswerCareerRule;
 ...
 * 
 * @author ChenQi
 * @date 2017年11月13日17:23:20
 */
@Json(value = { "uid", "fromuid", "to", "touseruid", "fromusername", "fromuseruid", "tousername", "status", "type", "content", "ip", "title", "adminname", "createtime" , "fromVisitorAvatar", "fromVisitorName"}, ignoreTypeStrategy = Json.webStrategy, strategy = Json.webStrategy)
public class Answer extends BaseEntity {

	private static final long serialVersionUID = -8682811314575792169L;
	private String fromuid;// 所评论的UID
	private String tittle;// 所回答问题的标题
	...
	public long getPrizecount() {
		Rule rule = new PrizeCountAnswerCareerRule(this.uid);
	...
	public Long getCommentcount() {
		Rule rule = new CareerProblemSecondCommentCountRlue(this.uid);

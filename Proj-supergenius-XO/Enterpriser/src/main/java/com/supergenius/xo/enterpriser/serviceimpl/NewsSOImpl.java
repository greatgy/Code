...
public class NewsSOImpl extends BaseSOImpl<News> implements NewsSO{
	...
	public News add(Map<String, Object> map) {
		...
		if (type.equals(EEnterpriserMsg.commentsarticle) || type.equals(EEnterpriserMsg.replycomments)) {
		...
		news.setType(EEnterpriserMsg.get(Integer.parseInt(type)));

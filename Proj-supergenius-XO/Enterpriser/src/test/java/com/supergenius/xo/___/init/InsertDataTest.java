...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryEnterpriserDB2;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GEnterpriserDB2";
	
	@Test
	public void insertGEnterpriserDB2Data() throws IOException {
		System.out.println("-----------invoking method: insertGEnterpriserDB2Data");
		...
		try {
			...
			conn = sqlSessionFactoryEnterpriserDB2.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGUserDB2TestData() throws IOException {
		System.out.println("-----------invoking method: insertGEnterpriserDB2TestData");

...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryGLifeDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GLifeDB";
	
	@Test
	public void insertGLifeDBData() throws IOException {
		...
		try {
			...
			conn = sqlSessionFactoryGLifeDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGLifeDBTestData() throws IOException {

...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryStartupDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GStartupDB";
	
	@Test
	public void insertGStartupDBData() throws IOException {
		System.out.println("-----------invoking method: insertGStartupDBTestData");
		...
		try {
			...
			conn = sqlSessionFactoryStartupDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGStartupTestData() throws IOException {
		System.out.println("-----------invoking method: insertGStartupDBTestData");

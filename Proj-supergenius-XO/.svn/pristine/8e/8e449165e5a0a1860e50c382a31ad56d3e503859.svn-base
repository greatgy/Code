...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactorySolrDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GSolrDB";
	
	@Test
	public void insertGSolrDBData() throws IOException {
		System.out.println("-----------invoking method: insertGSolrDBTestData");
		...
		try {
			...
			conn = sqlSessionFactorySolrDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGSolrTestData() throws IOException {
		System.out.println("-----------invoking method: insertGSolrDBTestData");

...
public class CommentsSOImpl extends BaseSOImpl<Comments> implements CommentsSO {
	...
	@Override
	public boolean isNotPrized(String fromuid, String fromuseruid, EEntrepreneurChannel channel) {
		Map<String, Object> map = getParamMap();
		map.put(MapperDict.fromuid, fromuid);
	...
	@Override
	public boolean deleteByPraise(String fromuseruid, String fromuid, EEntrepreneurChannel channel) {
		Map<String, Object> map = getParamMap();
		map.put(MapperDict.fromuseruid, fromuseruid);
		map.put(MapperDict.fromuid, fromuid);
		map.put(MapperDict.type, EComment.praise);

...
public class InsertDataTest {
	@Autowired
	SqlSessionFactory sqlSessionFactoryFinanceDB2;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GFinanceDB2";
	
	@Test
	public void inserFinanceData() throws IOException {
		logger.info("-----------invoking method: insertWebData");
		...
		try {
			...
			conn = sqlSessionFactoryFinanceDB2.openSession().getConnection();
			for (String sql : strs) {
	...
	@Test
	public void insertFinanceTestData() throws IOException {
		logger.info("-----------invoking method: insertWebTestData");

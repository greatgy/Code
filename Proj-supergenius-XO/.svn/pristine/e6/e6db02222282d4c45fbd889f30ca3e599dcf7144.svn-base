...
public interface CommentsSO extends BaseSO<Comments>{
	 ...
	 * @return
	 */
	boolean isNotPrized(String fromuid, String fromuseruid, EManagernewsChannel channel);
	 ...
	 * @param channel
	 */
	boolean deleteByPraise(String fromuseruid, String fromuid, EManagernewsChannel channel);

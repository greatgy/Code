...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryGEntrepreneurDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GEntrepreneurDB";
	
	@Test
	public void insertGEntrepreneurDBData() throws IOException {
		System.out.println("-----------invoking method: insertGLifeDBData");
		...
		try {
			...
			conn = sqlSessionFactoryGEntrepreneurDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGEntrepreneurDBTestData() throws IOException {
		System.out.println("-----------invoking method: insertGLifeDBTestData");

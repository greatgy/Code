 ...
 * 
 * @author ChenQi
 * @date 2017年11月13日16:50:05
 */
@Service("CareerNewsSOImpl")
public class NewsSOImpl extends BaseSOImpl<News> implements NewsSO {
	...
	public News add(Map<String, Object> map) {
		...
		if (type.equals(ECareerMsg.commentsarticle) || type.equals(ECareerMsg.replycomments)) {
		...
		news.setType(ECareerMsg.get(Integer.parseInt(type)));

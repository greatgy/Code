...
import com.supergenius.xo.moralnews.rule.PrizeCountCommentsMoralnewsRule;
...
public class Comments extends BaseEntity implements Comparable<Comments> {
	...
	private EMoralnewsChannel channel;// 频道
	...
	public EMoralnewsChannel getChannel() {
		return channel;
	}

	public void setChannel(EMoralnewsChannel channel) {
		this.channel = channel;
	}

	@Json(strategy = Json.webStrategy)
	public String getChannelName() {
		return EMoralnewsChannel.getName(channel, Locale.CHINA);
	}
	...
	public Long getCommentcount() {
		Rule rule = new MoralnewsSecondCommentCountRule(this.uid);
	...
	public long getPrizecount() {
		Rule rule = new PrizeCountCommentsMoralnewsRule(this.uid);

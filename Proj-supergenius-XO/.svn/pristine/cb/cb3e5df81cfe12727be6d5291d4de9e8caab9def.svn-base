...
public class TestConst {
	...
	public static final String uid3 = "uid33333333333333333333333333333";
	
	public static final String adminuid = "adminuid000000000000000000000000";

	public static final int oid = 1;
	
	public static final String usersn = "testusersn";
	
	public static final String judgesn = "testjudgesn";

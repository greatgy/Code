...
public class InsertDataTest {
	...
	@Autowired
	SqlSessionFactory sqlSessionFactoryManagerNewsDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GManagerNewsDB";
	
	@Test
	public void insertGManagerNewsDBData() throws IOException {
		System.out.println("-----------invoking method: insertGManagerNewsDBData");
		...
		try {
			...
			conn = sqlSessionFactoryManagerNewsDB.openSession().getConnection();
			for (String sql : strs) { 
	...
	@Test
	public void insertGManagerNewsDBTestData() throws IOException {
		System.out.println("-----------invoking method: insertGManagerNewsDBTestData");

...
import com.supergenius.core.rule.PrizeCountCmtStartupRule;
...
public class Comments extends BaseEntity {
	...
	public long getPrizecount() {
		Rule rule = new PrizeCountCmtStartupRule(this.uid);
	...
	public Long getCommentcount() {
		Rule rule = new StartupCommentCountArticleRule(this.uid);

...
public class InsertDataTest {
	@Autowired
	SqlSessionFactory sqlSessionFactoryAccountDB;

	Logger logger = LoggerFactory.getLogger(this.getClass());

	private static final String strDBName = "GAccountDB";
	
	@Test
	public void inserAccountData() throws IOException {
		...
		try {
			...
			conn = sqlSessionFactoryAccountDB.openSession().getConnection();
			for (String sql : strs) {
	...
	@Test
	public void insertAccountTestData() throws IOException {

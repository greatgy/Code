...
public class EssayHP extends BaseHP {
	 ...
	 * @author ChenQi
	 */
	public static List<User> getUserForToday(Long cid) {
		Map<String, Object> map = getParamMap();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Essay> getEssayHot(int pagenum, int pagesize, Long cid) {
		String path = SysConf.SerialBasePath + "/life/" + cid + SysConf.SerialEssayPath;
		...
		if (list.size() == 0) {
			...
			List<Essay> tempList = new ArrayList<>();

CKEDITOR.dialog.add('musicupload', function(editor) { // 要和plugin.js 中的command 一致
	...
	return {
		...
		onOk : function() {
			...
			var element = CKEDITOR.dom.element.createFromHtml( '<div class="pcaudiodiv"><img class="pcaudioimg" id="imgAudio" data-type="true" src="'+ g.webimg + origin1 +'" alt="" /><audio id="audioEle" style="width:100%;" src="'+url+'" controls="controls"></audio ></div>');

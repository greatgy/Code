...
<body>
	<div class="contentLeft">
		...
		<div class="sharefriends">
			...
			<p>
				立即分享，让朋友帮点赞:
				<div class="bdsharebuttonbox" style="float: right;margin-top: -30px;margin-right:140px;overflow:inherit;">
					<a href="#" class="bds_weixin" style="margin: 0 6px 6px 0;" data-cmd="weixin" title="分享到微信"></a>
					<a href="#" class="bds_tsina" style="margin: 0 6px 6px 0;" data-cmd="tsina" title="分享到新浪微博"></a>
				</div>	
			</p>
		</div>
...
<script>
		...
		$(function(){
			prizeBindEvent();
			window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"32"},"share":{},"image":{"viewList":["weixin","tsina"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["weixin","tsina"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='${base}/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
		});

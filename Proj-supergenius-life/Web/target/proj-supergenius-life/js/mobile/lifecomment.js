...
function loadmore(){
	 if( num == 1){
            var url = base + "/m/ajax/lifecomment/"+channel+"_" + cid+"_"+fromuid+"_{0}".format(num)+"?commentuid="+commentuid;
        }else{
            var url = base + "/m/ajax/lifecomment/"+channel+"_" + cid+"_"+fromuid+"_{0}".format(num)+"?commentuid=com";
        }
	$.ajax({
		type:"GET",
		url:url,

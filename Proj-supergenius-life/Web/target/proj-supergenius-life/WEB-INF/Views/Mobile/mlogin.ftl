...
<head>
	...
	<link rel="stylesheet" href="${basecss}/css/mobile/default/login.css">
...
<body>
		<div class="loginBox">
			<form class="forminfor">
				<ul class="loginList">
					<li>
						<label for="mail"><span class="loginitem usericon" style="background:#c7c7c7 url(${baseimg}/imgs/default/loginUser.png) no-repeat center center;"></span></label>
						<input type="mail" id="mail" name="mail" placeholder="请输入登录邮箱" oninput="loginButton();">
					</li>
					<li>
						<label for="password"><span class="loginitem pswicon" style="background:#c7c7c7 url(${baseimg}/imgs/default/psw.png) no-repeat center center;"></span></label>
						<input type="text" id="phonepassword" name="phonepassword" placeholder="请输入密码" oninput="loginButton();">
					</li>
				</ul>
				<div class="warninginform">
						<img src="${baseimg}/imgs/default/waring.png" alt="不匹配" />
						您输入的账号或密码不匹配，请重新输入
				</div>

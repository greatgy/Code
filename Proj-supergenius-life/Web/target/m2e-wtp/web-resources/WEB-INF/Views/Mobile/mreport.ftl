...
<link href="${basecss}/css/mobile/default/index.css" type="text/css" rel="stylesheet" />
...
<body>
	<div class="answerQuestionBox questionBox">
		<form id="contribute" class="draft" action="${base}/m/life/my/report" method="post" enctype="multipart/form-data">
			<ul class="reportDetail">
				<li>
					<span class="itemlabel"><i>*</i>举报对象</span>
					<div class="reportNames reportRight">
				...
				<li>
					...
					<div class="reportReason reportRight">

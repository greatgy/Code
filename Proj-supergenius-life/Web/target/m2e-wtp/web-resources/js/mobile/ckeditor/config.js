...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_MyToolbar = [
        { name: 'insert', items : ['Mupload','Flash','Insertcode','Iframe' ] },
        { name: 'paragraph', items : ['CreateDiv']}
    ];
	
	config.toolbar = 'MyToolbar2';
	config.toolbar_MyToolbar2 = [
        { name: 'insert', items : ['Mupload','Flash','Insertcode', 'Iframe', 'CreateDiv'] },
    ];
	...
	config.toolbar_MyToolbar1 = [
			...
			[ 'Link', 'Unlink', 'Anchor' ], [ 'Image', 'Flash','Insertcode', 'Table' ],
			[ 'SpecialChar', 'PageBreak' ],  [ 'Style', 'FontFormat' ],
			[ 'FontName', 'FontSize' ], [ 'TextColor', 'BGColor' ],
			[ 'Maximize', 'ShowBlocks','Iframe' ] 
		];
	config.toolbar = 'MyToolbarLifeTravel';
	config.toolbar_MyToolbarLifeTravel = [
  			[ 'Paste', 'PasteText', 'PasteWord'],
			[ '-', 'Find', 'Replace', '-','TextColor', 'BGColor','FontName', 'FontSize' ], 
			[ 'Bold', 'Italic', 'Underline', '-', 'Subscript', 'Superscript' ],
			[ 'Outdent', 'Indent', 'Blockquote'],
			[ 'JustifyLeft', 'JustifyCenter', 'JustifyRight' ],
			[ 'Image', 'Flash','Insertcode', 'Table' ],
			[ 'SpecialChar', 'PageBreak' ],  [ 'Style', 'FontFormat' ],
	];
	...
	config.extraPlugins = 'musicupload,lineheight,selectall,notification,notificationaggregator,widgetselection,filetools,lineutils,widget,uploadwidget,uploadimage,insertcode';

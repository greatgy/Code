...
function submitCommentHandler(obj){
	...
	$.post(base + "/m/ajax/addessay/" + cid, params,function(data){
...
function loadmore(){
	...
	var url= "";
	if (type == 0) {
		url = base + "/m/ajax/essay/"+cid+"_{0}".format(num);
	} else {
		url = base + "/m/ajax/essay/hot/"+cid+"_{0}".format(num);
	}
	$.ajax({
		type:"GET",
		url:url,
...
function getcomment(obj){
	var url = base + "/m/ajax/essay/"+firstuid+"_"+cid+"_{0}".format(pagenum);
	$.ajax({
		type:"GET",
		url:url,
		success:function(data){
...
function deleteComment(obj){
	...
	var url = base + "/m/ajax/essay/delete/"+commentuid+"/"+fromuseruid+"/"+useruid;
	$.ajax({
		type:"GET",
		url:url,
		success:function(data){

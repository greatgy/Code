...
<body>
	<div class="contentLeft articleComment">
		<div class="articleBox">
			...
			<div class="detailTips">
				...
				[#if "${bean.origin}" != "" && cid != 274877906944]
			...
			<div class="articleContent">
				${bean.content}
				<span style="font-size:12px;color:#999999;float: left;">声明：本文观点仅代表作者本人，与本网站无关。</span>
			</div>
			<div class="shareBox">
				...
				<a href="javascript:;" [#if me??]id="btncollectarticle_${bean.uid}" data-iscollect="${bean.iscollect!'false'}" class="littleicon"[#else]class="littleicon pop-up" [/#if]>
	...
	<div class="contentRight">
		<div class="rightItem rightItemBox">
			...
			[/#if]
			[#if hotArticleList?? && hotArticleList?size>0]
				<h3>热门文章</h3>

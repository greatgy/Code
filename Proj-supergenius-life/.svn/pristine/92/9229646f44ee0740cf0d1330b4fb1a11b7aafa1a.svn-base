...
[#if list??]
	[#list list as article]
			[#if article.imgmedium??]
				<li>
					<a class="tabitemimg" href="${base}/article/[#if cid??]${cid?c}[#else]${(article.firstCid)?c}[/#if]/${(article.oid)?c}">
						<img src="${webimg}${article.imgmedium}" alt="${article.title}" title="${article.title}" />
					</a>
					<div class="tabitemRt">
						<a href="${base}/article/[#if cid??]${cid?c}[#else]${(article.firstCid)?c}[/#if]/${(article.oid)?c}" class="articleTitle">
						...
						<div class="timepiece">
							...
							<div class="operateBox">
								<a href="${base}/article/[#if cid??]${cid?c}[#else]${(article.firstCid)?c}[/#if]/${(article.oid)?c}" class="littleicon">

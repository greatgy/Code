	...
	<script type="text/javascript">
		...
		$(function(){
		    ...
		    $("#hot").click(function(){
				...
				$.ajax({
					type:"GET",
					url:"${base}/ajax/essay/hot/${cid?c}_1",
		...
		[#list list as item]
			...
			<div class="dreamitem dreamitem${i}">
				...
				<div class="userdream">
					...
					<div class="dreamDetail">
						<a href="javascript:;" class="closebutton1"><img src="${baseimg}/imgs/default/close.png" alt="关闭" title="关闭" /></a>
						<h4>我的理想</h4>

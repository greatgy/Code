...
<body>
		...
		<div class="header_fix">
			[#include "/WEB-INF/FtlLib/Web/BaseDecorators/HeaderTopnav.ftl" /]
		</div>
		<div class="header_fix_phone">
			[#include "/WEB-INF/FtlLib/Web/BaseDecorators/HeaderTop.ftl" /]
			[#include "/WEB-INF/FtlLib/Web/BaseDecorators/HeaderSecond.ftl" /]
		</div>

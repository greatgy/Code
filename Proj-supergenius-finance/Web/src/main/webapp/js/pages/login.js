...
var defaultInitLogin = function() {
	...
	$(".uname img").attr("src", baseimg + "/imgs/default/userbefore.png");
	$("form [name='password']").val("");
	$(".upswd img").attr("src", baseimg + "/imgs/default/psword.png");
...
$(function(){
	$("form.inputs .usersinform").focus(function(){
		$(".uname img").attr("src", baseimg + "/imgs/default/userafter.png");
	});
	...
	$("form.inputs .psword").focus(function(){
		$(".upswd img").attr("src", baseimg + "/imgs/default/pswordafter.png");
	});

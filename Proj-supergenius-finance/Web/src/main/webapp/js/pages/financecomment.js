...
function submitCommentHandler(obj){
	...
	$.post(base + "/ajax/my/comment/{0}".format(params.fromuid), params,function(data){
...
function addComment(bean, obj){
	...
	if($(parentobj).attr("class").indexOf("articleComment") != -1){
		...
		html += '<div class="name">';
		if (me != "" || me != null || typeof me != 'undefined') {
			html += '<a href="'+base+"/finance/uhome/"+me.uid+'">';
		} else {
...
function deleteComment(obj){
	...
	var url = base + "/ajax/comments/delete/"+commentuid+"/"+fromuseruid+"/"+useruid;
	$.ajax({
		type:"GET",
		url:url,
		success:function(data){

		...
		[@a.search]
        	...
        	<tr>
                <td>板块：
                    ...
                    <input type="radio" id="index" name="type" value="5" /><label for="index">首页</label>
                </td>
        	</tr>
		[/@a.search]
   ...
   [@a.addsection onclicksubmit="submitHandlerForAdd(this)"]
   		<tr>
            ...
            <td id="addcontent"><input type="radio" id="ad" name="type" value="0" checked/><label for="ad">职场心得</label>
                ...
                <input type="radio" id="detail-add" name="type" value="3" /><label for="detail-add">文章详情页</label> 
                <input type="radio" id="index-add" name="type" value="5" /><label for="index-add">首页</label> 
            </td>
        </tr>
        <tr>
            <td>名称:</td>
    ...
    [@a.editsection onclicksubmit="submitHandlerForEdit(this)"]
        ...
        <tr>
            ...
            <td id="editcontent"><input type="radio" id="ad" name="type" value="0"/><label for="ad">职场心得</label>
                <input type="radio" id="guide" name="type" value="1"/><label for="guide">职场八卦</label>
                <input type="radio" id="other" name="type" value="2" /><label for="other">招聘指南</label> 
                <input type="radio" id="edit-detail" name="type" value="3" /><label for="edit-detail">文章详情页</label> 
                <input type="radio" id="edit-index" name="type" value="5" /><label for="edit-index">首页</label> 

    ...
    <section>
   	    ...
   	    [@a.editsection canuploadfile=true]
	        ...
	        <tr>
 				...
 				<td>
		    		...
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue4" value="8"><label for="edit_catalogue8">职业道德与信用</label>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue8" value="16"><label for="edit_catalogue16">商业谋略与欺诈</label>
        ...
        <tr>
         ...
         <tr>
			<td>版块:</td>
			<td>
	    		<input name="cids" set-key="isVisionPattern" checked  type="radio" id="catalogue2" value="2"><label for="catalogue2">职业道德缺失与批判</label>
	    		<input name="cids" set-key="isManagementPlan" type="radio" id="catalogue4" value="4"><label for="catalogue4">职业道德与执行力</label>
	    		<input name="cids" set-key="isSalaryIncentive" type="radio" id="catalogue8" value="8"><label for="catalogue8">职业道德与信用</label>
	    		<input name="cids" set-key="isPromotionJob" type="radio" id="catalogue16" value="16"><label for="catalogue16">商业谋略与欺诈</label>
	    		<input name="cids" set-key="isFashionLife" type="radio" id="catalogue32" value="32"><label for="catalogue32">忠诚及其悖论</label>
			</td>
	      </tr>
        <tr>
            <td>摘要：</td>            

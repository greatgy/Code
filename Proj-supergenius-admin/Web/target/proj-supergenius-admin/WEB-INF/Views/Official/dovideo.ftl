        ...
        [@a.search]
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" name="type" value="2"/>PC视频
                    <input type="radio" name="type" value="3"/>移动端视频
                </td>
            </tr>
            <tr>
                <td>起始发布时间：</td>
            ...
            <td>
      		 <div class="channel">
      		    [#list map?keys as mkey]
                    <input type="radio" id="rdchannel_${mkey_index}" name="type" value="${mkey}"/> <label for="rdchannel_${mkey_index}">${map[mkey]}</label>&nbsp;
                [/#list]
      		 </div>
            </td>
        </tr>

...
<body>
    <section>
		...
		[/@a.search]
        [@a.datagrid url="${base}${baseAdminPath}/${site}/ajax/teasearticle/list" options="fitColumns:true,resizeHandle:'right',pagination:true,singleSelect:false,method:'get'"]
        ...
        <input name="cataloguetype" type="hidden" value="11">
        <tr>
            <td>正文:</td>
            <td>[@a.ckeditor name="content" /]</td>
        </tr>

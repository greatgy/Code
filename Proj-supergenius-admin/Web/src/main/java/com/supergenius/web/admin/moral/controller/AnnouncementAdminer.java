...
import com.supergenius.web.admin.moral.helper.AnnouncementHP;
...
public class AnnouncementAdminer extends BaseController {
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/announcement" }, method = RequestMethod.GET)
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/list" }, method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/add" }, method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/edit" }, method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/delete" }, method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/status/{status:\\d+}" }, method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/up" }, method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> announcement_up(String ids) {
		if (announcementSO.announcement_up(ids)) {
			return success();
		}
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/down" }, method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> announcement_down(String ids) {
		if (announcementSO.announcement_down(ids)) {
			return success();
		}
		return result(MsgKeyDict.doFailed);
	}
	 ...
	 * @author LiJiacheng
	 */
	@RequestMapping(value = { "/moral/ajax/announcement/istop/{istop:\\d+}" }, method = RequestMethod.GET)
	@ResponseBody

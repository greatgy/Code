...
import com.supergenius.core.rule.StartupCommentCountArticleRule;
import com.supergenius.global.conf.UriConf;
import com.supergenius.server.common.constants.MsgKeyDict;
import com.supergenius.server.common.constants.ViewKeyDict;
import com.supergenius.server.startup.util.ArticleRedisUtil;
import com.supergenius.web.admin.startup.helper.CommentsHP;
...
import com.supergenius.xo.startup.service.CommentsSO;

/**
 * 评论管理controller
 * 
 * @author ChenQi
 * @date 2017年8月24日15:08:10
 */
@Controller
@RequestMapping(value = UriConf.baseAdminPath)
public class StartupCommentsAdminer extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value = { "/startup/startupcomments" }, method = RequestMethod.GET)
	public String statistic(Map<String, Object> model, HttpServletRequest request) {
		model.put(ViewKeyDict.channel, EChannel.startupcomments.name());
		model.put(ViewKeyDict.site, ESite.startup.name());
		model.put(ViewKeyDict.channelname, EChannel.getName(EChannel.startupcomments, Locale.CHINA));
	 ...
	 * @return
	 */
	@RequestMapping(value = { "/startup/ajax/startupcomments/list" }, method = RequestMethod.GET)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/startup/ajax/startupcomments/delete", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> comments_delete(String[] ids) {
		...
		if (comments != null) {
			...
			if (StrUtil.isNotEmpty(comments.getTouid())) {
				Rule rule = new StartupCommentCountArticleRule(comments.getData());
				RedisUtil.decr(rule);
	 ...
	 */
	@RequestMapping(value = "/startup/ajax/startupcomments/status", method = RequestMethod.POST)
	@ResponseBody

...
import com.supergenius.web.admin.startup.helper.MusicHP;
...
public class MusicAdminer extends BaseController {
	 ...
	 * @return String
	 */
	@RequestMapping(value = "/startup/music", method = RequestMethod.GET)
	public String music(Map<String, Object> model, HttpServletRequest request) {
		model.put(ViewKeyDict.channel, EChannel.music.name());
		model.put(ViewKeyDict.channelname, EChannel.getName(EChannel.music, Locale.CHINA));
	 ...
	 * 
	 * @author 许志翔
	 * @date 2017年8月9日15:43:22
	 * @return String
	 */
	@RequestMapping(value = "/startup/ajax/music/list", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<Map<String, Object>> music_list(Map<String, Object> model, HttpServletRequest request) {
		cloneParamsToModel(model, request);
		Map<String, Object> searchMap = MusicHP.query(model);
	 ...
	 */
	@RequestMapping(value = "/startup/ajax/music/delete", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> music_delete(String[] ids) {
		for (String id : ids) {
			...
			if (music != null) {
				...
				adminLog.setChannel(EChannel.music.toInt());
	 ...
	 * @param temp  本地还是网络
	 * @author 许志翔
	 * @data 2017年8月9日15:54:30
	 * @return
	 */
	@RequestMapping(value = "/startup/ajax/music/add", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/startup/ajax/music/edit", method = RequestMethod.POST)
	@ResponseBody

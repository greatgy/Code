...
public class GossipArticleAdminer extends BaseController{
	 ...
	 * @return String
	 */
	@RequestMapping(value = "/career/gossiparticle", method = RequestMethod.GET)
	public String article(Map<String, Object> model, HttpServletRequest request) {
		...
		map.put(MapperDict.cid, ECatalogue.gossip);
	 ...
	 * @return String
	 */
	@RequestMapping(value = "/career/ajax/gossiparticle/list", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<Map<String, Object>> article_list(Map<String, Object> model, HttpServletRequest request) {
		cloneParamsToModel(model, request);
		Map<String, Object> searchMap = CareerArticleHP.query(model, ECatalogue.gossip);
	 ...
	 */
	@RequestMapping(value = "/career/ajax/gossiparticle/topcount", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<Map<String, Object>> problem_topcount(Map<String, Object> model, HttpServletRequest request) {
		model.put(MapperDict.count, CareerArticleHP.getTopArticleCount(ECatalogue.gossip));

...
function submitHandlerForEdit(obj, dg) {
	...
	if(val == 2){
		$.get('${base}${baseAdminPath}/finance/ajax/financecontent/guidecount', function(result) {
			if (result.count >= 5) {
				err("应聘指南相关推荐超过5个！");
		        return false;
			}else{
   ...
   [@a.addsection]
        ...
        <tr>
   		...
   		<tr>
            <td>选择类型:</td>
            <td id="addcontent">
		      <input type="radio" id="addcontent_1" name="type" value="1" checked/><label for="addcontent_1">banner</label>
		      <input type="radio" id="addcontent_2" name="type" value="2"/><label for="addcontent_2">首页广告位</label>
            </td>
        </tr>
        <tr>
            <td>是否显示:</td>
    ...
    [@a.editsection onclicksubmit="submitHandlerForEdit(this)"]
        ...
        <tr>
            <td>选择类型:</td>
            <td id="editcontent">
            	<input type="radio" id="addcontent_1" name="type" value="1"/><label for="addcontent_1">banner</label>
            	<input type="radio" id="addcontent_2" name="type" value="2"/><label for="addcontent_2">首页广告位</label>
            </td>
        </tr>
        <tr>

...
function myButtonHandler(obj, url) {
		...
		var flag = false;
		if (objid == "disable") {
		    confirmPostAjax('冻结该选项', '确定要冻结该文章吗？', '${base}${baseAdminPath}/${site}/ajax/moralnewsarticle/status/0', "post");
		}
		if (objid == "enable") {
		    confirmPostAjax('解冻该选项', '确认要解冻该文章吗？', '${base}${baseAdminPath}/${site}/ajax/moralnewsarticle/status/1', "post");
		}
}
    ...
    <section>
        	...
        	<tr>
 				<td>版块:
		    		...
		    		[#if catelogueList??]
					    [#assign i=0]
					    [#list catelogueList as item]
					    	[#if item.cid != 1 && item.cid != 64 && item.cid != 256]
        ...
        [/@a.viewsection]
   	    [@a.editsection canuploadfile=true]
	        ...
	        <tr>
	 			<td>版块:</td>
 				<td>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue2" value="2"><label for="edit_catalogue2">职业道德缺失与批判</label>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue4" value="4"><label for="edit_catalogue4">职业道德与执行力</label>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue8" value="8"><label for="edit_catalogue8">职业道德与信用</label>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue16" value="16"><label for="edit_catalogue16">商业谋略与欺诈</label>
		    		<input name="cids" type="radio" class="editcatelogue" id="edit_catalogue32" value="32"><label for="edit_catalogue32">忠诚及其悖论</label>
				</td>
	        </tr>
	        <tr> 
	            <td>摘要：</td>            
        ...
        <tr>
         ...
         <tr>
			<td>版块:</td>
			<td>
	    		<input name="cids" set-key="isVisionPattern" checked  type="radio" id="add_catalogue2" value="2"><label for="add_catalogue2">职业道德缺失与批判</label>
	    		<input name="cids" set-key="isManagementPlan" type="radio" id="add_catalogue4" value="4"><label for="add_catalogue4">职业道德与执行力</label>
	    		<input name="cids" set-key="isSalaryIncentive" type="radio" id="add_catalogue8" value="8"><label for="add_catalogue8">职业道德与信用</label>
	    		<input name="cids" set-key="isPromotionJob" type="radio" id="add_catalogue16" value="16"><label for="add_catalogue16">商业谋略与欺诈</label>
	    		<input name="cids" set-key="isFashionLife" type="radio" id="add_catalogue32" value="32"><label for="add_catalogue32">忠诚及其悖论</label>
			</td>
	      </tr>
        <tr>
            <td>摘要：</td>            

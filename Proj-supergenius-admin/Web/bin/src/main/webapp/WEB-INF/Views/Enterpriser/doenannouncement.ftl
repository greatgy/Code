...
<body>
    <section>
        ...
        [@a.datagrid]
            ...
            <th data-options="field:'catalogueName',width:200">所属板块</th>
        ...
        [@a.toolbar]
            [@a.status/]
            [@a.state nameenable="置顶" namedisable="取消置顶" statefield="istop" actionenable="${base}${baseAdminPath}/enterpriser/ajax/${channel}/istop/1" actiondisable="${base}${baseAdminPath}/enterpriser/ajax/${channel}/istop/0"/]
        [/@a.toolbar]
    ...
    [@a.addsection]
        <tr>
            <td>所属板块：</td>
            <td>
                <input type="radio" id="cidthree" name="cid" value="22" checked="checked"/><label for="cidthree">引资购商论坛</label>

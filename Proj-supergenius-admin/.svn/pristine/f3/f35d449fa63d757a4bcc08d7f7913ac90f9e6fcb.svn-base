 ...
 * 
 * @author LouPengYu
 * @date 2018年2月1日下午5:03:56
 */
public class EnterpriserCatalogueHP extends BaseHP {

	private static AdminSO adminSO;
	private static CatalogueSO catalogueSO;
	
	private static Logger log = LoggerFactory.getLogger(EnterpriserCatalogueHP.class);

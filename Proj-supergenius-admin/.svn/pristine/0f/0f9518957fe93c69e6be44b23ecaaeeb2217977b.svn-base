...
function myButtonHandler(obj, url) {
		...
		var flag = false;
		if (objid == "disable") {
		    confirmPostAjax('冻结该选项', '确定要冻结该文章吗？', '${base}${baseAdminPath}/${site}/ajax/entrepreneurarticle/status/0', "post");
		}
		if (objid == "enable") {
		    confirmPostAjax('解冻该选项', '确认要解冻该文章吗？', '${base}${baseAdminPath}/${site}/ajax/entrepreneurarticle/status/1', "post");
		}
}
    ...
    <section>
   	    ...
   	    [@a.editsection canuploadfile=true]
	        ...
	        <tr>
 				...
 				<td>
		    		...
		    		<input name="cids" type="checkbox" class="editcatelogue" id="edit_catalogue2" value="2"><label for="edit_catalogue2">格局</label>
		    		<input name="cids" type="checkbox" class="editcatelogue" id="edit_catalogue4" value="4"><label for="edit_catalogue4">谋断</label>
		    		<input name="cids" type="checkbox" class="editcatelogue" id="edit_catalogue8" value="8"><label for="edit_catalogue8">管控</label>
		    		<input name="cids" type="checkbox" class="editcatelogue" id="edit_catalogue16" value="16"><label for="edit_catalogue16">用人之道</label>
		    		<input name="cids" type="checkbox" class="editcatelogue" id="edit_catalogue32" value="32"><label for="edit_catalogue32">创始人&继承者</label>
				</td>
	        </tr>
	        <tr>
	            <td>摘要：</td>            
        ...
        <tr>
 				...
 				<td>
		    		...
		    		<input name="cids" set-key="isPattern" type="checkbox" id="catalogue2" value="2"><label for="catalogue2">格局</label>
		    		<input name="cids" set-key="isStrategy" type="checkbox" id="catalogue4" value="4"><label for="catalogue4">谋断</label>
		    		<input name="cids" set-key="isControl" type="checkbox" id="catalogue8" value="8"><label for="catalogue8">管控</label>
		    		<input name="cids" set-key="isManagerPeople" type="checkbox"  id="catalogue16" value="16"><label for="catalogue16">用人之道</label>
		    		<input name="cids" set-key="isOriginator" type="checkbox"  id="catalogue32" value="32"><label for="catalogue32">创始人&继承者</label>
				</td>
	        </tr>
        <tr>
            <td>摘要：</td>            

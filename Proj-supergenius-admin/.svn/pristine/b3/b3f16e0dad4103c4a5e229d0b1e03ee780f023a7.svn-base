...
<body>
    <section>
		[@a.search]
        	...
        	<tr>
                <td>板块：
                    ...
                    <input type="radio" id="major" name="cid" value="8388608" /><label for="major">专业匹配</label>
                    <input type="radio" id="excellent" name="cid" value="16777216" /><label for="excellent">大学优选</label>
                    <input type="radio" id="design" name="cid" value="1073741824" /><label for="design">人生设计</label>
                </td>
            </tr>
		[/@a.search]
        [@a.datagrid]
            <th data-options="field:'content',width:50">回答内容</th>
            <th data-options="field:'title',width:50">回答对象</th>
        ...
        [@a.viewsection]
	        ...
	        <tr><td>回答内容</td><td><span set-key="content"></span></td></tr>

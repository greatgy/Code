...
<body>
    <section>
		...
		[/@a.search]
        [@a.datagrid url="${base}${baseAdminPath}/${site}/ajax/puzzledarticle/list" options="fitColumns:true,resizeHandle:'right',pagination:true,singleSelect:false,method:'get'"]

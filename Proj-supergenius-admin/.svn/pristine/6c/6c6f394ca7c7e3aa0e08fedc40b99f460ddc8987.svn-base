...
import com.supergenius.xo.enterpriser.enums.ETop;
import com.supergenius.xo.enterpriser.rule.EnterpriserFirstVideoRule;
 ...
 */
public class EnterpriserVideoHP extends BaseHP {
	...
	public static void handleCache() {
		Rule rule = new EnterpriserFirstVideoRule();

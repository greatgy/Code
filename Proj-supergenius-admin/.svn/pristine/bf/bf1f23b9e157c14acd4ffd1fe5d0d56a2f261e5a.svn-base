...
import com.supergenius.server.entrepreneur.util.ArticleRedisUtil;
import com.supergenius.web.admin.entrepreneur.hellper.EntrepreneurCommentsHP;
...
import com.supergenius.xo.entrepreneur.rule.EntrepreneurCommentCountArticleRule;
...
public class EntrepreneurCommentsAdminer extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value = { "/entrepreneur/entrepreneurcomments" }, method = RequestMethod.GET)
	public String statistic(Map<String, Object> model, HttpServletRequest request) {
		model.put(ViewKeyDict.channel, EChannel.entrepreneurcomments.name());
		model.put(ViewKeyDict.site, ESite.entrepreneur.name());
		model.put(ViewKeyDict.channelname, EChannel.getName(EChannel.entrepreneurcomments, Locale.CHINA));
		...
		model.put(ViewKeyDict.allCount, EntrepreneurCommentsHP.getUserCount());
		return "doentrepreneurcomments";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = { "/entrepreneur/ajax/entrepreneurcomments/list" }, method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<Map<String, Object>> comments_list(Map<String, Object> model, HttpServletRequest request) {
		cloneParamsToModel(model, request);
		Map<String, Object> searchMap = EntrepreneurCommentsHP.query(model);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/entrepreneur/ajax/entrepreneurcomments/delete", method = RequestMethod.GET)
	@ResponseBody
	public Map<String, Object> comments_delete(String[] ids) {
		...
		if (comments != null) {
			...
			if (StrUtil.isNotEmpty(comments.getTouid())) {
				Rule rule = new EntrepreneurCommentCountArticleRule(comments.getData());
				RedisUtil.decr(rule);
	 ...
	 */
	@RequestMapping(value = "/entrepreneur/ajax/entrepreneurcomments/status", method = RequestMethod.POST)
	@ResponseBody

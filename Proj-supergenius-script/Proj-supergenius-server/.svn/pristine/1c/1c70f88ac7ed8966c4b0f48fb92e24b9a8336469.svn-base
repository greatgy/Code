package com.supergenius.server.finance.util;
...
import com.supergenius.xo.finance.rule.ClickCountFinanceLabelRule;
 ...
 */
public class FinanceLabelRedisUtil extends BaseUtil {
	...
	public static int getInt(String uid) {
		...
		Rule rule = new ClickCountFinanceLabelRule(uid);

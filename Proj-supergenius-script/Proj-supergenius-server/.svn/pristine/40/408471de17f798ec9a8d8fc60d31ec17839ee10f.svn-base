package com.supergenius.server.enterpriser.util;
...
import com.supergenius.xo.enterpriser.rule.EnterpriserForumRlue;
 ...
 */
public class ForumRedisUtil extends BaseUtil {
	...
	public static boolean set(String uid, Map<String, Object> map) {
		Rule rule = new EnterpriserForumRlue(uid);
